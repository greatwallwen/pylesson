...
#运行完上面代码后，打开 terminal，进入你存放的文件夹地址上一层，
# 运行conda activate tensorflow，进入conda环境，激活TensorFlow
# 要取消TensorFlow环境，运行命令conda deactivate
#  tensorboard --logdir='logs/'
# 后会返回一个地址，注意这个地址中要把名称换成loaclhost
